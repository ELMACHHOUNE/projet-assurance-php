...
<section
    ...
    >
      <!-- Optional blue overlay for contrast -->
      ...
      >
        ...
        <h2 class="text-2xl sm:text-3xl font-bold mb-4">
          Votre demande de tarif flotte entreprise est bien prise en compte
        </h2>

        <!-- Subtitle -->
        <p class="text-base sm:text-lg text-gray-100 mb-6">
          Vous recevrez très bientôt une offre personnalisée pour l'assurance de
          votre flotte d'entreprise.
        </p>
        ...
        >
          Revenir à l'accueil flotte entreprise
        </a>
      </div>
    </section>
