@extends('master')
@section('title', 'Assurance transport de marchandise - Mentions légales')
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <span class="contenuindex">En envoyant un courrier électronique à la société ou en accédant et/ou
                utilisant le Site Internet www.lassurance-des-transporteurs.fr///, chaque
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <span class="contenuindex">Le site www.lassurance-des-transporteurs.fr/// est édité par la société
