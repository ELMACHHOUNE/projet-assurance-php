...
$("#nom").keyup(function(){
    ...
    if($("#nom").val()=="")
        ...
        $("#nom").css({"border-color":"none","border-style": "none"});
  ...
  $("#prenom").keyup(function(){
    if($("#prenom").val()=="")
        ...
        $("#prenom").css({"border-color":"none","border-style": "none"});
  ...
  $("#marque").keyup(function(){
    if($("#marque").val()=="")
        ...
        $("#marque").css({"border-color":"none","border-style": "none"});
  ...
  $("#code").keyup(function(){
    ...
    if( ($("#code").val()=="") || ($("#code").val().length !=5) )
        ...
        $("#code").css({"border-color":"none","border-style": "none"});
  ...
  $("#tele").keyup(function(){
    ...
    $("#tele").css({"border-color":"none","border-style": "none"});
  ...
  $("#bt1").click(function(){
    ...
    /*----------------------------------verfication form*/
     ...
     if($("#myselect00").val()==""){
      $("#myselect00").css({"border-color":"#c14c4c","border-style": "solid"});
      return false;
  }
